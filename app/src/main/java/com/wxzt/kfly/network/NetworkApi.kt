...
import com.wxzt.kfly.network.api.ApiService
import com.wxzt.lib_common.network.api.BaseNetworkApi
import com.wxzt.lib_common.network.interceptor.CacheInterceptor
import com.wxzt.lib_common.viewmodel.appContext

import com.wxzt.lib_common.network.interceptor.logging.LogInterceptor
...
val apiService: ApiService by lazy(mode = LazyThreadSafetyMode.SYNCHRONIZED) {
    NetworkApi.INSTANCE.getApi(ApiService::class.java, Api.BASE_TEST_ADDRESS)
}
